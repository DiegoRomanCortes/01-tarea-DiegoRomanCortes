...
plt.ylabel('$y = x^{k/2 - 1}e^{-x}$', fontsize=13)
...
plt.plot(x, y)
plt.xlabel('x', fontsize=13)
plt.ylabel(r'$y = (-\ln (x))^{K/2 - 1}$', fontsize=13)
plt.fill_between(x, y)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.show()
...
plt.xscale('log')
plt.yscale('log')
plt.xlabel('Tolerancia relativa para Simpson', fontsize=13)
plt.ylabel('Promedio de errores absolutos cometido', fontsize=13)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.show()
 """
...
plt.xscale('log')
plt.yscale('log')
plt.xlabel('Tolerancia absoluta para bisección', fontsize=13)
plt.ylabel('Error absoluto cometido', fontsize=13)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel(r'y = $\chi ^2 (x)$', fontsize=13)
...
plt.xlabel('x', fontsize=13)
plt.ylabel(r'y=$\int_0^x \chi^2(t)dt$', fontsize=13)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
